...
| Heat, evidence, the police response | `sim/heat` | `heat.toml` | `docs/corners.md`, `docs/snitching.md` | `TestRichHiderIsNeverIndicted` (#27), `balance_test.go` |
