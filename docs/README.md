...
| Dilemma cards | `game/dilemmas.go`, `game/preview.go`, `sim/news/dilemmas.go`, `engine/card.go`, `ui/card.go` | `dilemmas.toml` | `docs/dilemmas.md` | `dilemmas_test.go`, `TestTriggersHold`, `TestEverySlotIsFilledByItsTrigger`, `TestPreviewIsTheOutcome`, `TestChoiceChipsSayTheLines`, `TestCardShowsWhatEachChoiceDoes` |
