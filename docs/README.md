...
| The cart, the dialogs, the delta; where a dialog opens (#462) | `ui/cart.go`, `ui/dialogs.go` (`productInView`), `ui/market.go` `priceFacts` | | `docs/cart.md`, `docs/modals.md` | `cart_test.go`, `delta_test.go`, `toggle_test.go`, `TestDialogOpensWhereItSays` |
