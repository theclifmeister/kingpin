...
| Dilemma cards | `game/dilemmas.go`, `sim/news/dilemmas.go`, `ui/card.go` | `dilemmas.toml` | `docs/dilemmas.md` | `dilemmas_test.go`, `TestTriggersHold`, `TestEverySlotIsFilledByItsTrigger` |
