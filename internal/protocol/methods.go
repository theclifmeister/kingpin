...
var commands = []string{
	...
	"SetLaunderDial", "BuyFront", "Invest", "BuyAsset", "BuyTrophy", "Reserve", "SetSweep", "StopSweep", "CashOut", "BuyUpgrade",
...
var paramNames = map[string][]string{
	...
	"Reserve": {"amount"}, "SetSweep": {"keep"}, "StopSweep": {}, "CashOut": {"amount"}, "BuyUpgrade": {"upgrade"},
