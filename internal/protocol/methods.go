...
var commands = []string{
	...
	"SetLaunderDial", "BuyFront", "Invest", "BuyAsset", "BuyTrophy", "Reserve", "SetSweep", "StopSweep", "SetTill", "CashOut", "BuyUpgrade",
...
var paramNames = map[string][]string{
	...
	"Reserve": {"amount"}, "SetSweep": {"keep"}, "StopSweep": {}, "SetTill": {"amount"}, "CashOut": {"amount"}, "BuyUpgrade": {"upgrade"},
