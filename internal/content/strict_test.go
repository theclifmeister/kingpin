...
func TestEveryFileRefusesAnUnknownKey(t *testing.T) {
	...
	targets := map[string]any{
		...
		"intel.toml": &c.Intel, "assets.toml": &c.Assets, "exports.toml": &c.Exports, "trophies.toml": &c.Trophies, "endings.toml": &c.Endings,
		"characters.toml": &c.Characters, "presets.toml": &c.Presets, "ambitions.toml": &c.Ambitions,
	}
