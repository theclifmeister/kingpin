...
func TestSimsWriteOnlyTheirOwnState(t *testing.T) {
	owned := map[string][]string{
		...
		"rivals":     {"Rivals", "Rival", "Faction", "Offers", "Over", "Reign", "ReignSlip", "Reigns", "War", "Takes"},                           // the endings it owns (#49): kingpin (the reign's stamp since #227), taken_out, the table's betrayed; the war order it ends (#229)
