...
//
// Territory holds the rivals slot until the rival sim lands beside it;
// logistics and laundering slot in as they land.
func Default(cfg *content.Config) (*Set, []game.Simulation, error) {
	...
	return set, []game.Simulation{set.Market, set.Territory, set.Crew, set.Heat, set.News}, nil
}
...
// player on the starting one, and a hiring pool drawn from the day-0 RNG so
// it is part of the seed like everything else.
