...
func TestTheLabMultipliesTheCook(t *testing.T) {
	...
	w := game.NewWorld(7, []game.StartingCity{{ID: lab.City, Name: "Lab City", Products: []game.StartingProduct{{ID: "a", Name: "A", Price: 10, Demand: 5}}}, {ID: "other", Name: "Other", Products: []game.StartingProduct{{ID: "a", Name: "A", Price: 10, Demand: 5}}}}, 1000, 100)
	s := crew.New(cfg)
